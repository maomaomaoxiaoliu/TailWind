...
export default () => (
  <div style={{marginBottom: '20rem'}}>
    ...
    <div className="bg-gray-400">
      <img className="object-scale-down h-48 w-full ..." src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80" />
    </div>
     */}
  </div>
)
